...
date: 2026-08-20 10:12:27 +0545

image:
  path: /assets/img/posts_thumbnails/breakme.png
  alt: "Breakme TryHackMe"

description:  are the coverings of this Breakme room.

categories: [Web, Linux]
tags: [web, linux, wordpress, nmap, gobuster, wpscan, curl, hydra, pspy, chisel, tunneling, specialCharacterBypass, IFS, raceCondition, john, pythonJailBreak, 𝘣𝘳𝘦𝘢𝘬𝘱𝘰𝘪𝘯𝘵, command injection, TOCTOU]
...
To exploit this, I intercepted the profile modify request using Burp and append `&wpda_role[]=administrator` to our request data as follows:
...
```
i downloaded readme file from my attacker machine browser with url `breakme.thm:9000` and used the online Reveerse Engineering webiste ie [dogbolt](https://dogbolt.org ) to decompile the binary.
