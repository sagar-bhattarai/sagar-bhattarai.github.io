...
date: 2026-08-09 10:07:33 +0545

image:
  path: /assets/img/posts_thumbnails/smol.png
  alt: "Smol TryHackMe"

description: web application enumeration, WordPress exploitation, credential discovery, and Linux privilege escalation are the coverings of this Smol room.

categories: [Web, Linux]
tags: [web, linux, nmap, gobuster, fuff, wordpress, wpscan, john]
...
This is a detailed walkthrough of how I rooted the **Smol** room on TryHackMe and captured both user and root flags. The room involved `web application enumeration`, `WordPress exploitation`, `credential discovery`, and `Linux privilege escalation`.
...
/xmlrpc.php
```
![Gobuster](/assets/images/writeups/smol/smol_2.png)
...
```
![WPScan](/assets/images/writeups/smol/smol_3.png)

![WPScan](/assets/images/writeups/smol/smol_4.png)

![WPScan](/assets/images/writeups/smol/smol_5.png)

![WPScan](/assets/images/writeups/smol/smol_6.png)
...
```php
DB_USER = wpuser
DB_PASSWORD = kbLSF2 <REDACTED> 29*Z%G
```
![Credentials](/assets/images/writeups/smol/smol_7.png)
...
```
![Login](/assets/images/writeups/smol/smol_7.png)
...
![Backdoors](/assets/images/writeups/smol/smol_10.png)

![Backdoors](/assets/images/writeups/smol/smol_9.png)
...
![hello.php](/assets/images/writeups/smol/smol_11.png)
...
```
![Decode](/assets/images/writeups/smol/smol_12.png)
...
www-data
```
![command Execution](/assets/images/writeups/smol/smol_13.png)
...
```
![Dump Database](/assets/images/writeups/smol/smol_14.png)
---
...
```
Recovered Password: sand <REDACTED> ornia

![Crack Password](/assets/images/writeups/smol/smol_15.png)
...
```
![SSH](/assets/images/writeups/smol/smol_16.png)
...
```
Recovered:
- Zip Password: hero <REDACTED> il.com
...
```
Recovered:
- User `xavi` Password: P@ssw <REDACTED> vi@

![Backup File Attack](/assets/images/writeups/smol/smol_17.png)
...
🖼️ **all process screenshot** ![all process screenshot](/assets/images/writeups/smol/smol_17.png)
