...
image:
  path: /assets/img/posts_thumbnails/blog.png
  alt: "Blog TryHackMe"

description: Wordpress Enumeration, brute force attacks, and privilege escalation through misconfigured SUID binaries are the coverings of this Blog room.

categories: [Web, Linux]
tags: [web, linux, wordpress, nmap, gobuster, smbclient, enum4linux, steghide, metasploit, ghrida , ltrace ]
...
![nmap](/assets/images/writeups/blog/blog_1.png)
...
```
![smbclient](/assets/images/writeups/blog/blog_2.png)
...
```
![wpscan](/assets/images/writeups/blog/blog_3.png)
...
![wpscan](/assets/images/writeups/blog/blog_4.1.png)
...
- **kwheel password:** `cu <REDACTED> e1`
Nice, im an authenticated user account.

![wpscan](/assets/images/writeups/blog/blog_5.png)
...
```
![searchsploit](/assets/images/writeups/blog/blog_6.png)
...
run
```
![searchsploit](/assets/images/writeups/blog/blog_7.png)
...
🖼️ **all process screenshot** ![all process screenshot](/assets/images/writeups/blog/all_process.png)
