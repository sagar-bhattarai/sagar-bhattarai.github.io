...
This is a detailed walkthrough of how I rooted the **Valley** room on TryHackMe and captured flags.
...
![nmap](/assets/images/writeups/valley/valley_1.png)

![nmap](/assets/images/writeups/valley/valley_2.png)
...
```
![Enumeration](/assets/images/writeups/valley/valley_3.png)
...
![Enumeration](/assets/images/writeups/valley/valley_4.png)
...
![Enumeration](/assets/images/writeups/valley/valley_5.png)
...
![Exploitation](/assets/images/writeups/valley/valley_7.png)
...
```
![Privilege Escalation](/assets/images/writeups/valley/valley_8.png)

i found the part were the authentication works and there is a string that looks like an `md5 hash` ie `e6722920bab <REDACTED> f6b1b58ac` and i cracked it since that file belongs to user `valley` and it was password for this user.

![Privilege Escalation](/assets/images/writeups/valley/valley_9.png)
...
```
![Privilege Escalation](/assets/images/writeups/valley/valley_10.png)
...
```
![Privilege Escalation](/assets/images/writeups/valley/valley_11.png)

And after a minute i get the bash shell.

![Privilege Escalation](/assets/images/writeups/valley/valley_12.png)
...
🖼️ **All process screenshots** ![`all_process`](/assets/images/writeups/valley/all_process.png)
