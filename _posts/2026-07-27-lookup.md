...
categories: [TryHackMe, Web, Linux]
tags: [nmap, burpsuite, hydra, metasploit, GTFOBins, sudo, pwn, look, elfinder]
image:
  path: /assets/img/posts/lookup.png
  alt: "Look Up TryHackMe"
---

The room involved `web application enumeration`, `brute force attacks`, a `command injection vulnerability`, and `privilege escalation` through misconfigured binaries.
